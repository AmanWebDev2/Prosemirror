      ...
      <form className="czi-form" onSubmit={(e) => e.preventDefault()}>
        <div class=" flex flex-col gap-2">
          <div class="flex flex-col px-3 pt-3 gap-2">
            <div class="smartlinks-input-container ">
              <input
              ...
              <div class="absolute right-1 z-10">
                ...
                >
                  <svg
                    class="interface-icon o__standard o__standard__custom-data"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
          ...
          <div class="smart-links__list flex flex-col overflow-auto -mx-1">
            <div class="smart-links-wrapper hover:text-blue hover:bg-blue-light cursor-pointer flex flex-row items-center px-4 py-2 gap-4">
              <div style={{
                marginRight:'16px'
              }}>
                <svg
              ...
              <div class="flex flex-col flex-1 u__one-truncated-line">
               {url}
              </div>
            </div>

            <div class="smart-links__list-two flex flex-row items-center gap-1 text-sm pl-4 py-1 h-9">
              ...
              >
                <svg
                  class="kudoshub-icon o__standard o__standard__trigger o__by-text"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <span class="text-blue">Smart Links</span>
              <span class="text-gray">
                - Use this link to trigger other content from your library
              </span>
            </div>

            <div class="smart-links-info flex flex-row items-center px-4 gap-4 h-8">
              <div class="decoration__line w-px bg-gray ml-2 h-6 mb-2"></div>
              <div class="text-gray"
              style={{
                marginRight:'16px'
              }}
              >
                <svg
                  class="interface-icon o__standard o__standard__error"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="flex flex-col flex-1 u__one-truncated-line text-gray">
