...
const ImagePopover = (props) => {
    ...
    const translateMenuPos=(menuNode)=>{
      ...
      setElementProperties(menuNode,{
        transform: `translate(${translate.translateX - menuNodeRect.width/2}px,${
    ...
    <div className="kudoshub-prosemirror-popover kudoshub-prosemirror-composer-pointer">
        <div>
            <div className="d-flex">
                ...
                <div className="d-flex">
                    <div className="flex">
                        <input placeholder="Enter a link" class="kudoshib-prosemirror-composer-editor-box-input o__with-icon" data-test-image-editor-link-url-input="" type="text"
